...
public:
    ...
    [[nodiscard]] std::vector<std::pair<int, int>> GetNextVertices(int vertex) const override; // vertex, weight
    [[nodiscard]] std::vector<std::pair<int, int>> GetPrevVertices(int vertex) const override; // vertex, weight
...
int Relax(std::vector<int>& path_min_weights, int from_to_edge_weight, int from, int to, std::vector<int>& parents) {
...
int min_path(const IWeightGraph& graph, int from, int to) {
    ...
    std::vector<int> path_min_weights(graph.VerticesCount(), INT_MAX);
    ...
    std::set<std::pair<int, int>, decltype(cmp)> priority_queue(cmp);
    ...
    while ( !priority_queue.empty() ) {
        ...
        std::pair<int, int> current = *cur; priority_queue.erase(cur);
